...
Also, an IP address: 192.164.1.1. The date is 2002-01-05, 
and a PAN number is COYHL4797P.
"""
...
Dates: ['2002-01-05']
PAN Numbers: ['COYHL4797P']
Entities: [('IP', 'ORG'), ('192.164.1.1', 'CARDINAL'), ('2002-01-05', 'DATE'), ('PAN', 'ORG'), ('COYHL4797P.', 'NORP')]
